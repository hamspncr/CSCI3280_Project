  ...
  useEffect(() => {
    ...
    ws.current.onopen = async () => {
      ...
      if (!username) {
        ...
        // Legacy microphone input. In order to use third party library Tone.js for
        // voice changing capabilities, we use their input function
        /*
        ...
        */
        ...
        // Provided in context, sets effects before joining the room
      ...
      if (event === "join-room") {
        ...
        if (!joined.current) {
          ...
          payload.users.forEach(async (user) => {
            // When we join the room, we call all the users in the room
            ...
            if (user.userId !== userId) {
              ...
              // This is identical to below, but without any effects to our voice
              /*
